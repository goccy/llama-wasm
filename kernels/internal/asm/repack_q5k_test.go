...
func TestA64Q5K8x8KernelGate(t *testing.T) {
	...
	dir := t.TempDir()
	writeRunTree(t, dir, "quantrun", "arm64", asm, quantRunCommon+kQuantRunSrc+q4Kx8RunSrc+q5Kx8RunSrc+q6Kx8Decls, q5Kx8RunTest, "GemmKernel", "dbg_gemm_q5_K_8x8", "GemvKernel", "dbg_gemv_q5_K_8x8")
...
func TestX64Q5K8x8KernelGate(t *testing.T) {
	...
	dir := t.TempDir()
	writeRunTree(t, dir, "quantrun", "amd64", asm, quantRunCommon+kQuantRunSrc+q4Kx8RunSrc+q5Kx8RunSrc+q6Kx8Decls, q5Kx8RunTest, "GemvKernel", "dbg_gemv_q5_K_8x8", "GemmKernel", "dbg_gemm_q5_K_8x8")
