...
func TestA64MXFP4_8x8KernelGate(t *testing.T) {
	...
	dir := t.TempDir()
	writeRunTree(t, dir, "quantrun", "arm64", asm, quantRunCommon+q5x8RunSrc+q4x8RunSrc+mxfp4RunSrc+mxfp4x8RunSrc+q5x8Decls, mxfp4x8RunTest, "GemmKernel", "dbg_gemm_mxfp4_8x8", "GemvKernel", "dbg_gemv_mxfp4_8x8")
...
func TestX64MXFP4_8x8KernelGate(t *testing.T) {
	...
	dir := t.TempDir()
	writeRunTree(t, dir, "quantrun", "amd64", asm, quantRunCommon+q5x8RunSrc+q4x8RunSrc+mxfp4RunSrc+mxfp4x8RunSrc+q5x8Decls, mxfp4x8RunTest, "GemmKernel", "dbg_gemm_mxfp4_8x8", "GemvKernel", "dbg_gemv_mxfp4_8x8")
