...
func TestA64Q4_0_8x8KernelGate(t *testing.T) {
	...
	dir := t.TempDir()
	writeRunTree(t, dir, "quantrun", "arm64", asm, quantRunCommon+q5x8RunSrc+q4x8RunSrc+q5x8Decls, q4x8RunTest, "GemmKernel", "dbg_gemm_q4_0_8x8", "GemvKernel", "dbg_gemv_q4_0_8x8")
...
func TestX64Q4_0_8x8KernelGate(t *testing.T) {
	...
	dir := t.TempDir()
	writeRunTree(t, dir, "quantrun", "amd64", asm, quantRunCommon+q5x8RunSrc+q4x8RunSrc+q5x8Decls, q4x8RunTest, "GemmKernel", "dbg_gemm_q4_0_8x8", "GemvKernel", "dbg_gemv_q4_0_8x8")
