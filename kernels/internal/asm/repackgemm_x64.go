...
func x64RepackGemmKernel(sym string, feature string, pool *ConstPool, wide bool) string {
	...
	w("\tSHLQ\t$2, R15")
	w("\tMOVL\tR11, 24(SP)")
	// One body per feature level: the avx512vnni body takes the VNNI
	// nest, the avx2 body falls through to the AVX2 nest.
