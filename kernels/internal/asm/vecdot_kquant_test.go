...
func TestA64VecDotKQuantKernelGate(t *testing.T) {
	...
	dir := t.TempDir()
	writeRunTree(t, dir, "quantrun", "arm64", asm, quantRunCommon+kQuantRunSrc+kQuantDecls, kQuantRunTest, "Q4KKernel", "dbg_vec_dot_q4_K_q8_K", "Q6KKernel", "dbg_vec_dot_q6_K_q8_K")
...
func TestX64VecDotQuantKernelShape(t *testing.T) {
	...
	k := x64QuantConsts()
	if len(k) != 992 || k[960+17] != 1 || k[896+9] != 1 || k[928+7] != 128 || int8(k[832+7]) != 12 || int8(k[832+31]) != -12 || k[800] != 0x10 || int8(k[768]) != -127 || int8(k[768+31]) != 113 || k[96+8] != 1 || k[128] != 0xfe || k[288+32*3] != 6 || k[288+32*3+1] != 7 || k[544+16*7+8] != 15 || k[672] != 1 || k[704+31] != 2 || k[736] != 32 {
