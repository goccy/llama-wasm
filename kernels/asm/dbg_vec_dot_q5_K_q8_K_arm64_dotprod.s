// dbg_vec_dot_q5_K_q8_K: q5_K x q8_K dot, SDOT per sub-block with MLA-by-element scales, fifth bits from qh; 2x2 tile for nrc == 2.
...
q5kblk:
	WORD $0x3cc10072 // ldur q18, [x3, #16]
	WORD $0x3cc20073 // ldur q19, [x3, #32]
	...
	WORD $0x4e2e1e51 // and v17.16b, v18.16b, v14.16b
	WORD $0x4f0c5631 // shl v17.16b, v17.16b, #4
	WORD $0x4eb11f5a // orr v26.16b, v26.16b, v17.16b
	WORD $0x4e2e1e71 // and v17.16b, v19.16b, v14.16b
	WORD $0x4f0c5631 // shl v17.16b, v17.16b, #4
	WORD $0x4eb11f7b // orr v27.16b, v27.16b, v17.16b
	WORD $0x4e2f1e51 // and v17.16b, v18.16b, v15.16b
	WORD $0x4f0b5631 // shl v17.16b, v17.16b, #3
	WORD $0x4eb11f9c // orr v28.16b, v28.16b, v17.16b
	WORD $0x4e2f1e71 // and v17.16b, v19.16b, v15.16b
	WORD $0x4f0b5631 // shl v17.16b, v17.16b, #3
	WORD $0x4eb11fbd // orr v29.16b, v29.16b, v17.16b
	WORD $0x6f0e0652 // ushr v18.16b, v18.16b, #2
	WORD $0x6f0e0673 // ushr v19.16b, v19.16b, #2
	...
	WORD $0x3cc90074 // ldur q20, [x3, #144]
	WORD $0x3cca0075 // ldur q21, [x3, #160]
...
q5ktileblk:
	...
	WORD $0x3cc1006e // ldur q14, [x3, #16]
	WORD $0x4f00e42d // movi v13.16b, #1
	WORD $0x4e2d1dce // and v14.16b, v14.16b, v13.16b
	WORD $0x4f0c55ce // shl v14.16b, v14.16b, #4
	WORD $0x4eae1e73 // orr v19.16b, v19.16b, v14.16b
	WORD $0x3cc2006e // ldur q14, [x3, #32]
	WORD $0x4f00e42d // movi v13.16b, #1
	WORD $0x4e2d1dce // and v14.16b, v14.16b, v13.16b
	WORD $0x4f0c55ce // shl v14.16b, v14.16b, #4
	WORD $0x4eae1e94 // orr v20.16b, v20.16b, v14.16b
	WORD $0x3cc1006e // ldur q14, [x3, #16]
	WORD $0x4f00e44d // movi v13.16b, #2
	WORD $0x4e2d1dce // and v14.16b, v14.16b, v13.16b
	WORD $0x4f0b55ce // shl v14.16b, v14.16b, #3
	WORD $0x4eae1e31 // orr v17.16b, v17.16b, v14.16b
	WORD $0x3cc2006e // ldur q14, [x3, #32]
	WORD $0x4f00e44d // movi v13.16b, #2
	WORD $0x4e2d1dce // and v14.16b, v14.16b, v13.16b
	WORD $0x4f0b55ce // shl v14.16b, v14.16b, #3
	WORD $0x4eae1e52 // orr v18.16b, v18.16b, v14.16b
	WORD $0x3cc100ae // ldur q14, [x5, #16]
	WORD $0x4f00e42d // movi v13.16b, #1
	WORD $0x4e2d1dce // and v14.16b, v14.16b, v13.16b
	WORD $0x4f0c55ce // shl v14.16b, v14.16b, #4
	WORD $0x4eae1ef7 // orr v23.16b, v23.16b, v14.16b
	WORD $0x3cc200ae // ldur q14, [x5, #32]
	WORD $0x4f00e42d // movi v13.16b, #1
	WORD $0x4e2d1dce // and v14.16b, v14.16b, v13.16b
	WORD $0x4f0c55ce // shl v14.16b, v14.16b, #4
	WORD $0x4eae1f18 // orr v24.16b, v24.16b, v14.16b
	WORD $0x3cc100ae // ldur q14, [x5, #16]
	WORD $0x4f00e44d // movi v13.16b, #2
	WORD $0x4e2d1dce // and v14.16b, v14.16b, v13.16b
	WORD $0x4f0b55ce // shl v14.16b, v14.16b, #3
	WORD $0x4eae1eb5 // orr v21.16b, v21.16b, v14.16b
	WORD $0x3cc200ae // ldur q14, [x5, #32]
	WORD $0x4f00e44d // movi v13.16b, #2
	WORD $0x4e2d1dce // and v14.16b, v14.16b, v13.16b
	WORD $0x4f0b55ce // shl v14.16b, v14.16b, #3
	WORD $0x4eae1ed6 // orr v22.16b, v22.16b, v14.16b
	...
	WORD $0x6f0c06d6 // ushr v22.16b, v22.16b, #4
	WORD $0x3cc1006e // ldur q14, [x3, #16]
	WORD $0x6f0c05ce // ushr v14.16b, v14.16b, #4
	WORD $0x4f00e42d // movi v13.16b, #1
	WORD $0x4e2d1dce // and v14.16b, v14.16b, v13.16b
	WORD $0x4f0c55ce // shl v14.16b, v14.16b, #4
	WORD $0x4eae1e73 // orr v19.16b, v19.16b, v14.16b
	...
	WORD $0x3cc90071 // ldur q17, [x3, #144]
	WORD $0x3cca0072 // ldur q18, [x3, #160]
	WORD $0x3cc900b5 // ldur q21, [x5, #144]
	WORD $0x3cca00b6 // ldur q22, [x5, #160]
	WORD $0x4e301e33 // and v19.16b, v17.16b, v16.16b
	WORD $0x4e301e54 // and v20.16b, v18.16b, v16.16b
	WORD $0x6f0c0631 // ushr v17.16b, v17.16b, #4
	WORD $0x6f0c0652 // ushr v18.16b, v18.16b, #4
	...
	WORD $0x6f0c06d6 // ushr v22.16b, v22.16b, #4
	WORD $0x3cc1006e // ldur q14, [x3, #16]
	WORD $0x6f0a05ce // ushr v14.16b, v14.16b, #6
	WORD $0x4f00e42d // movi v13.16b, #1
	WORD $0x4e2d1dce // and v14.16b, v14.16b, v13.16b
	WORD $0x4f0c55ce // shl v14.16b, v14.16b, #4
	WORD $0x4eae1e73 // orr v19.16b, v19.16b, v14.16b
